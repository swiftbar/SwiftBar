...
enum Localizable {
    enum App: String {
        ...
        case MenuBarRecoveryTitle = "APP_MENU_BAR_RECOVERY_TITLE"
        case MenuBarRecoveryInfo = "APP_MENU_BAR_RECOVERY_INFO"
        case OpenMenuBarSettings = "APP_OPEN_MENU_BAR_SETTINGS"
        case DismissButton = "APP_DISMISS"
        case OKButton = "OK"
